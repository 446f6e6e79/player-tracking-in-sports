...
\]
\[
\text{DetA} = \frac{TP}{TP+FN+FP}, \qquad
\text{AssA} = \frac{1}{TP}\sum_{c}\frac{TPA(c)}{TPA(c)+FNA(c)+FPA(c)}
\]
\[
\text{LocA} = \frac{1}{|TP|}\sum_{c\,\in\,TP}\text{IoU}(c) \quad\text{(mean overlap of matched boxes)}
\]
\end{frame}
...
\end{tabular}
\vspace{0.5em}
\par\footnotesize Errors in px; Acc columns are fractions. Fragment counts: 2, 5, 5.
\end{frame}

% ----- Qualitative outputs (stacked vertically) ----------------
\begin{frame}{Appendix: Qualitative Outputs, Detection (1/2)}
\centering
\includegraphics[width=0.92\textwidth]{../../media/appendix/02_inspect_mog2_detections.png}\\
{\scriptsize MOG2 foreground mask}\\[1.2em]
\includegraphics[width=0.92\textwidth]{../../media/appendix/04_inspect_yolo_detections.png}\\
{\scriptsize Pre-trained YOLOv11 detections}
\end{frame}

\begin{frame}{Appendix: Qualitative Outputs, Detection (2/2)}
\centering
\vfill
\includegraphics[width=0.92\textwidth]{../../media/appendix/05_inspect_merged_detections.png}\\
...
\centering
\includegraphics[width=0.92\textwidth]{../../media/appendix/07_inspect_sort_tracks.png}\\
{\scriptsize SORT tracks}\\[1.2em]
\includegraphics[width=0.92\textwidth]{../../media/appendix/10_inspect_resolved_labels.png}\\
...
\centering
\vfill
\includegraphics[width=0.92\textwidth]{../../media/appendix/12_inspect_smoothed_3d_reconstructions.png}\\
