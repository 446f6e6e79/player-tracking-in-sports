...
Both geometry errors are converted from pixels to millimetres by scaling each residual with the point depth and the focal length, so they measure physical distance and stay comparable across cameras.
