...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../assets/media/appendix/01_open_video_and_read_frames.png}
  \caption{Raw input frame.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../assets/media/appendix/02_inspect_mog2_detections.png}
  \caption{MOG2 foreground mask.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../assets/media/appendix/03_inspect_mog2_detections.png}
  \caption{MOG2 detections overlaid on the frame.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../assets/media/appendix/04_inspect_yolo_detections.png}
  \caption{Pre-trained YOLO26 detections.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../assets/media/appendix/10_inspect_resolved_labels.png}
  \caption{DeepSORT tracks after smoothing and label resolution.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{../assets/media/appendix/12_inspect_smoothed_3d_reconstructions.png}
