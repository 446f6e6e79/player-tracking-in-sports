# Vendored from https://github.com/KaiyangZhou/deep-person-reid
# (torchreid/models/osnet.py), commit master. MIT License, (c) 2018 Kaiyang Zhou.
# Trimmed: pretrained-weight download helpers removed; weights are loaded
# externally from a local file by AppearanceEncoder.
